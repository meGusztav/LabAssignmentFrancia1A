package com.example.jsu2.labassignmentfrancia1a;
...
public class IncrementDecrement extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_increment_decrement);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_increment_decrement, menu);
        return true;
    }
